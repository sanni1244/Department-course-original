    ...
    <div>
        ...
        <span class="hidden">LASU SIWES PROJECT</span>
            ...
            <div class="contents">
                ...
                <fieldset class="leg bars">
                    <div class="flexit flexit2">
                        <a href="pages/registration.php" class="legs">Register</a><br>
                        <a href="pages/login.php" class="legs">Log In</a>
                     </div>
                </fieldset>
            </div>
        </div>
        ...
        <div class="container">
            <div class="contents">
                ...
                <div class="flexit2 equal">
                    <h5>Click the register button if you haven't done so. <br>Only do so if this process hasn't been done before. </h5>
                    <h5>Click the Login button to view your profile. Once you visit your profile, your details will be available there.</h5>
                </div>
            </div>
        </div>
